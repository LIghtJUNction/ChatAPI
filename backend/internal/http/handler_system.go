...
func (h ReadinessHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	if h.Service == nil {
		http.Error(w, "readiness unavailable", http.StatusServiceUnavailable)
		return
	}
...
func (h MetricsHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	_, _ = w.Write([]byte(h.Registry.PrometheusText()))
}
...
func (h SetupHandler) HTML(w http.ResponseWriter, r *http.Request) {
	...
	_ = setupTemplate.Execute(w, map[string]any{"Status": status})
}
